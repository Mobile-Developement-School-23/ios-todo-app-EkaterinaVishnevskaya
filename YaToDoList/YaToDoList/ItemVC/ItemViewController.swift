...
class ItemViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if fileCache.todoList.count > 0 {
            for id in fileCache.todoList.keys {
                todo = fileCache.todoList[id] ?? TodoItem(text: "", importance: .normal, done: false)
            }
        }
...
extension ItemViewController: UITextViewDelegate {func textViewShouldBeginEditing(_ textView: UITextView) -> Bool {
